...
if($_POST) {
    ...
    $to_Email = "circula@circular.tech"; // Write your email here
    ...
    $headers .= 'From: My website <circula@circular.tech>' . "\r\n";
    $headers .= 'Reply-To: '.$_POST["userEmail"]."\r\n";
    
    'X-Mailer: PHP/' . phpversion();
    
    $subject = 'A message from circular.tech !'; //Modified by JaimeJS
    ...
    // original line : $Mailsending = @mail($to_Email, $_POST["userSubject"], $emailcontent, $headers);
